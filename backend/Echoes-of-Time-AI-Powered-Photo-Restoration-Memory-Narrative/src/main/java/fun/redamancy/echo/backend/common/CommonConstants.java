package fun.redamancy.echo.backend.common;

public class CommonConstants {

    public final static String SESSION = "session";
    public final static String USER_FILE_PATH = "/var/www/html/echo/image";
...
//    public final static String LINUX_RESOURCES_STATIC_PATH = "src/main/resources/static/";
    ...
    public final static String IMAGE_PATH = "http://chinese.redamancyxun.fun/echo/image/";
