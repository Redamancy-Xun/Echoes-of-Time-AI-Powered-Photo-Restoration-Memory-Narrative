package fun.redamancy.echo.backend.exception;
...
public enum EnumExceptionType {
    ...
    CREATE_PHOTO_STORY_FAILED(4001, "创建照片故事失败"),
    PHOTO_STORY_NOT_FOUND(4002, "照片故事不存在"),
    UPDATE_PHOTO_STORY_FAILED(4003, "更新照片故事失败"),
    INVALID_PHOTO_STORY_DESCRIPTION(4004, "照片故事描述不合法");
